...
class AutoGeneratedTool(Tool):
    ...
    def __init__(self, parent: Tool, method: Callable, name: str = None, description: str = None) -> None:
        """初始化自动生成的工具
    ...
    def _parse_parameters(self) -> List[ToolParameter]:
        ...
        type_hint = get_type_hints(self.method)
        ...
        for param_name, param in sig.parameters.items():
            ...
            # 获取类型
            param_type_hint = type_hint.get(param.name)
